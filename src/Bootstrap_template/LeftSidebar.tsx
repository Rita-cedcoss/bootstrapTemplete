...
const LeftSidebar = (props: midProps) => {
  return (
    // left sidebar
    <div className={`${props.display} border-end sidebar heading`}>
      <div className="col-12 bg-light pe-4 ps-4 pt-4">
        <div className="d-flex justify-content-between  align-items-center pe-2 ps-2 pb-2">
          <span>
            <i className="bi bi-grid pe-2 "></i>Dashboard
          </span>
        </div>
        <div
        ...
        >
          <span>
            <i className="bi bi-menu-button-wide pe-2"></i>Components
          </span>
        ...
        >
          <span>
            <i className="bi bi-journal-text pe-2"></i>Forms
          </span>
          <i className="bi bi-chevron-down ps-3"></i>
        </div>
        ...
        >
          <span>
            {" "}
            <i className="bi bi-layout-text-window-reverse pe-2"></i>Tables
          </span>
          <i className="bi bi-chevron-down ps-3"></i>
        </div>
        ...
        >
          <span>
            <i className="bi bi-bar-chart pe-2"></i>Charts icons
          </span>
          <i className="bi bi-chevron-down ps-3"></i>
        </div>
        ...
        >
          <span>
            {" "}
            <i className="bi bi-gem pe-2"></i>Icons
          </span>
          <i className="bi bi-chevron-down ps-3"></i>
        </div>
        ...
        <div className="d-flex justify-content-between   align-items-center p-2">
          <span>
            <i className="bi bi-question-circle pe-2"></i>F.A.Q
          </span>
        </div>
        <div className="d-flex justify-content-between   align-items-center p-2">
          <span>
            {" "}
            <i className="bi bi-envelope pe-2"></i>Contact
          </span>
        </div>
        <div className=" d-flex justify-content-between  align-items-center p-2">
          <span>
            <i className="bi bi-card-list pe-2"></i>Register
          </span>
        </div>
        <div className=" d-flex justify-content-between  align-items-center p-2">
          <span>
            <i className="bi bi-box-arrow-in-right pe-2"></i>Login
          </span>
        </div>
        <div className="d-flex justify-content-between   align-items-center p-2">
          <span>
            {" "}
            <i className="bi bi-dash-circle pe-2"></i>Error-404
          </span>
        </div>
      </div>
    </div>
